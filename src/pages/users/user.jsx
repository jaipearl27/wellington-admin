...
const navigate= useNavigate()
    ...
    console.log("first",users.UserData.result)
  ...
  <table className="min-w-full bg-white border border-gray-200">
    <thead>
      <tr>
        <th className="py-2 px-4 border-b border-gray-200 text-left text-gray-700 font-semibold">Name</th>
        <th className="py-2 px-4 border-b border-gray-200 text-left text-gray-700 font-semibold">Email</th>
        <th className="py-2 px-4 border-b border-gray-200 text-left text-gray-700 font-semibold">Image</th>
      </tr>
    </thead>
    <tbody>
      {users?.UserData?.result?.map((item, index) => (
        <tr key={index} className="hover:bg-gray-100">
          ...
          <td className="flex flex-row gap-4"><button className=" bg-slate-400 rounded-md p-2">edit</button>
          <button className=" bg-slate-400 rounded-md p-2">del</button>
          </td>
        </tr>
      ))}
    </tbody>
